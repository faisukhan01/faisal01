    ...
    >
      ...
      <div className="relative mx-auto max-w-[1320px] px-5 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-10 items-center">
        ...
        >
          ...
          <p className="mt-6 max-w-[520px] text-[16px] lg:text-[18px] leading-[1.6] text-[#525252]">
        ...
        <div className="relative h-[420px] sm:h-[520px] lg:h-[600px]">
          ...
          <motion.div
            ...
            className="absolute top-4 right-2 sm:right-6 z-20 rounded-2xl bg-white/85 backdrop-blur-md border border-white/60 shadow-premium p-3 pr-4 flex items-center gap-2.5"
          >
            <span className="h-8 w-8 rounded-lg bg-[#1d81f2]/10 flex items-center justify-center text-[#1d81f2]">
          ...
          <motion.div
            ...
            className="absolute bottom-20 left-0 sm:left-2 z-20 rounded-2xl bg-white/85 backdrop-blur-md border border-white/60 shadow-premium p-3 pr-4 flex items-center gap-2.5"
          >
