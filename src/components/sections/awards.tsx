        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-end mb-12">
          ...
          <div className="lg:col-span-4 grid grid-cols-3 gap-3">
            {[
              ...
              >
                <div className="text-[20px] font-semibold text-[#56ccf2] leading-none">
                  {s.v}
                </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {AWARDS.map((a, i) => (
            <motion.article
              ...
              className="group relative rounded-2xl bg-white/[0.04] backdrop-blur border border-white/10 p-6 overflow-hidden hover:bg-white/[0.06] hover:border-white/20 transition-all duration-300 lift-on-hover"
            >
              {/* Top accent strip */}
              <span
                aria-hidden
              ...
              <span
                aria-hidden
                className="pointer-events-none absolute -top-12 -right-12 h-28 w-28 rounded-full opacity-0 group-hover:opacity-30 transition-opacity duration-500 blur-2xl"
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <h3 className="mt-1.5 text-[16px] lg:text-[17px] font-semibold text-white leading-snug flex-1">
                  {a.title}
                </h3>
